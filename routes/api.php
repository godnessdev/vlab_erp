...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('pessoas')->name('api.pessoas.')->group(function () {
        ...
        Route::get('autocomplete', function (Request $request) {
            ...
            $service = app(\App\Domain\Identidade\Services\PessoaService::class);
        ...
        Route::post('validar-documento', function (Request $request) {
            ...
            $validator = app(\App\Domain\Identidade\Validators\DocumentoValidator::class);
            $tipo = \App\Domain\Identidade\Enums\TipoDocumento::from($request->get('tipo'));
