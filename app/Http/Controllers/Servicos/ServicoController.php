...
class ServicoController extends Controller
{
    ...
    public function opcoes(): JsonResponse
    {
        return response()->json([
            'success' => true,
            'data' => [
                'status_servico' => \App\Domain\Servicos\Enums\StatusServico::getOptions(),
                'classificacoes_fiscais' => \App\Domain\Servicos\Enums\ClassificacaoFiscalServico::getOptions(),
                'unidades_medida' => [
                    'UN' => 'Unidade',
                    'HR' => 'Hora',
                    'MÊS' => 'Mês',
